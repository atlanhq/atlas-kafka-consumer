...
public class EntityREST {
    ...
    @Consumes(Servlets.JSON_MEDIA_TYPE)
    @Timed
    public void processTasks(ObjectPropEvent objectPropEvent) throws AtlasBaseException {
        AtlasPerfTracer perf = null;
        ...
        try {
            ...
            entitiesStore.processTasks(objectPropEvent);
//            entityGraphMapper.processClassificationPropagationAddition(objectPropEvent.getAssetVertexId(), objectPropEvent.getTagVertexId());
        } finally {
            AtlasPerfTracer.log(perf);
        }
    }
