...
public class MigrationImport extends ImportStrategy {
    ...
    private AtlasEntityStoreV2 createEntityStore(AtlasGraph graph, AtlasTypeRegistry typeRegistry) {
        ...
        return new AtlasEntityStoreV2(graph, deleteDelegate, restoreHandlerV1, typeRegistry, entityChangeNotifier, entityGraphMapper, null, null,atlasRelationshipStoreV2, null, null, null);
    }
